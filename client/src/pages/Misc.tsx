...
export function Integrations() {
  const integrations = [
    { name: 'Webhook API', description: 'Receive real-time event notifications via HTTP webhooks', icon: '🔗', status: 'active' },
    { name: 'REST API', description: 'Full REST API access for custom integrations and automation', icon: '⚡', status: 'active' },
    { name: 'ERP System', description: 'Connect to your ERP for seamless data sync', icon: '🏭', status: 'coming_soon' },
    { name: 'Payment Gateway', description: 'Accept online payments via Razorpay, Stripe, etc.', icon: '💳', status: 'coming_soon' },
    { name: 'Shipping API', description: 'Real-time shipping rates and tracking integration', icon: '🚚', status: 'coming_soon' },
    { name: 'Accounting Software', description: 'Sync with Tally, QuickBooks, Zoho Books', icon: '📊', status: 'coming_soon' },
    { name: 'CRM Platform', description: 'Sync customer data with your CRM', icon: '👥', status: 'coming_soon' },
    { name: 'Email Marketing', description: 'Connect Mailchimp or SendGrid for campaigns', icon: '📧', status: 'coming_soon' },
  ];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {integrations.map(int => (
          <div key={int.name} className={`card border-2 ${
